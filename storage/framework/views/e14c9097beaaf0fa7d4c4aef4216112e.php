<?php $__env->startSection('title', 'Crear Usuario - Cloud Storage'); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control <?php $__errorArgs = ['quota_gb'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       id="quota_gb" name="quota_gb" value="<?php echo e(old('quota_gb', 10)); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/emilio/Escritorio/desarrollador/App Cloud Storage Autoalojada/resources/views/admin/users/create.blade.php ENDPATH**/ ?>